...
namespace Covid19ImmunityCert.Contracts.Base58Encoding
{
	//Credit https://gist.github.com/CodesInChaos/3175971#file-base58encoding-cs
	// Implements https://en.bitcoin.it/wiki/Base58Check_encoding
	public static class Base58Encoding
	{
		public const int CheckSumSizeInBytes = 4;

		public static byte[] AddBase58CheckSum(this byte[] data)
		{
		...
		public static byte[] VerifyBase58AndRemoveCheckSum(this byte[] data)
		{
			//Contract.Requires<ArgumentNullException>(data != null);
		...
		public static string EncodeBase58(this byte[] data)
		{
			//Contract.Requires<ArgumentNullException>(data != null);
		...
		public static string EncodeBase58WithCheckSum(this byte[] data)
		{
			//Contract.Requires<ArgumentNullException>(data != null);
			//Contract.Ensures(Contract.Result<string>() != null);
			return EncodeBase58(AddBase58CheckSum(data));
		}

		public static byte[] DecodeBase58(this string s)
		{
		...
		public static byte[] DecodeBase58WithCheckSum(this string s)
		{
			//Contract.Requires<ArgumentNullException>(s != null);
			//Contract.Ensures(Contract.Result<byte[]>() != null);
			var dataWithCheckSum = DecodeBase58(s);
			var dataWithoutCheckSum = VerifyBase58AndRemoveCheckSum(dataWithCheckSum);
